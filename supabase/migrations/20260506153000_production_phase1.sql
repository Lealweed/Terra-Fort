...
-- keep role marker in metadata fallback compatibility notes:
comment on table public.order_events is 'Operational order timeline events for customer/delivery/admin portals';
